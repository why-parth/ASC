 ...
 * For example,
        ...
        clearstr; // freeing the string that was dynamically allocated and was previously stored in var a
 * and,
        var a = Str("45.0");

        a = toFloat(a) clearstr; // a stores a Float 45
 *
